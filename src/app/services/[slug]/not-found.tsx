    ...
    <main className="flex flex-1 items-center px-8 py-[120px]">
      <div className="mx-auto flex w-full max-w-[793px] flex-col items-center gap-8 text-center">
        ...
        <div className="flex flex-col gap-4">
          <h1 className="text-[clamp(2.5rem,6vw,5rem)] leading-[1.05] tracking-[-0.04em]">
            {copy.notFoundTitle}
          </h1>
          <p className="text-[24px] leading-[1.2] tracking-[-0.72px] text-[#676767]">
            {copy.notFoundBody}
          </p>
        </div>
        <div className="flex flex-wrap justify-center gap-3">
          <Link href="/services" className={buttonClassName("green")}>

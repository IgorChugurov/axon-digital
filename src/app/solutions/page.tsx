...
const solutionsData = siteContent.pages.solutions;
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center">
                ...
                <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                  {solutionsData.sections.hero.description}
                </p>
                <div className="flex flex-wrap justify-center gap-4">
                  {solutionsData.sections.hero.features.map(
          ...
          <section className="w-full max-w-5xl mx-auto px-4 sm:px-6 md:px-8 py-16 md:py-24">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                {solutionsData.sections.solutionsGrid.title}
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {solutionsData.sections.solutionsGrid.solutions.map(
                (solution: any) => (
                  <Link
                    key={solution.slug}
